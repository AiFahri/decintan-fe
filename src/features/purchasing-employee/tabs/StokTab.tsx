...
export function StokTab() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-white">Stok Barang</h2>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full rounded-xl text-black bg-white border border-gray-200 py-2.5 pl-10 pr-4 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
          />
        </div>
